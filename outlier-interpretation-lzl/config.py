...
def get_parser(algorithm_name, parser):
    if algorithm_name == "aton":
        parser.add_argument('--nbrs_num', type=int, default=10, help='')
        parser.add_argument('--rand_num', type=int, default=10, help='')
        parser.add_argument('--alpha1', type=float, default=0.5, help='triplet loss factor in loss function')
        parser.add_argument('--alpha2', type=float, default=0.5, help='dis loss factor in loss function')
    ...
    elif algorithm_name == "pml":
        parser.add_argument('--nbrs_num', type=int, default=10, help='')
        parser.add_argument('--rand_num', type=int, default=10, help='')
        parser.add_argument('--rand_num_m', type=int, default=10, help='') #add m, the number of nbrs_num of outliers
        parser.add_argument('--n_epoch', type=int, default=25, help='')
        parser.add_argument('--batch_size', type=int, default=512, help='')
        parser.add_argument('--lr', type=float, default=0.1, help='')
        parser.add_argument('--n_linear', type=int, default=64, help='')
        parser.add_argument('--margin', type=float, default=5., help='')
        parser.add_argument('--margin_add', type=float, default=0.5,help='')
    elif algorithm_name == "pml_iforest":
        parser.add_argument('--nbrs_num', type=int, default=10, help='')
        parser.add_argument('--rand_num', type=int, default=10, help='')
        parser.add_argument('--rand_num_m', type=int, default=10, help='') #add m, the number of nbrs_num of outliers
        parser.add_argument('--n_epoch', type=int, default=25, help='')
        ...
        parser.add_argument('--margin', type=float, default=5., help='')
        parser.add_argument('--margin_add', type=float, default=0.5,help='')
    elif algorithm_name == "pml_ablation":
        parser.add_argument('--nbrs_num', type=int, default=10, help='')
        parser.add_argument('--rand_num', type=int, default=10, help='')
        parser.add_argument('--rand_num_m', type=int, default=10, help='') #add m, the number of nbrs_num of outliers
        parser.add_argument('--n_epoch', type=int, default=25, help='')
        ...
        parser.add_argument('--margin', type=float, default=5., help='')
        parser.add_argument('--margin_add', type=float, default=0.5,help='')
    elif algorithm_name == "pml_ablation2":
        parser.add_argument('--nbrs_num', type=int, default=10, help='')
        parser.add_argument('--rand_num', type=int, default=10, help='')
        parser.add_argument('--rand_num_m', type=int, default=10, help='') #add m, the number of nbrs_num of outliers
        parser.add_argument('--n_epoch', type=int, default=25, help='')
